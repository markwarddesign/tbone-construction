...
?>
<div class="bg-[#1f2926] text-stone-300 py-2.5 px-4 sm:px-6 lg:px-8 text-sm hidden sm:flex justify-between items-center border-b border-stone-700/50">
    <div class="flex space-x-8">
        ...
        <a href="mailto:<?php echo esc_attr( $email ); ?>" class="flex items-center hover:text-white transition-colors">
