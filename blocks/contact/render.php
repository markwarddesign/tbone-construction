    ...
    <div class="grid lg:grid-cols-3 gap-12 mt-12 bg-white border border-stone-200 shadow-xl overflow-hidden">
      ...
      <div class="lg:col-span-1 bg-[#1f2926] text-white p-10 lg:p-12 relative overflow-hidden">
        ...
        <div class="relative z-10 space-y-12">
          <div>
            <h3 class="font-serif text-2xl text-[#c25e24] mb-6"><?php echo $sidebar_heading; ?></h3>
            <div class="space-y-6">
              <div class="flex items-start">
                <?php echo tw_icon( 'phone', 'w-6 h-6 text-stone-400 mr-4 shrink-0' ); ?>
                <div>
                  <p class="text-sm font-bold tracking-widest uppercase text-stone-500 mb-1"><?php echo $call_label; ?></p>
              ...
              <div class="flex items-start">
                ...
                <div>
                  <p class="text-sm font-bold tracking-widest uppercase text-stone-500 mb-1"><?php echo $email_label; ?></p>
          ...
          <?php if ( $area_label || $area_text ) : ?>
            <div class="pt-8 border-t border-white/10">
              <div class="flex items-start">
                ...
                <div>
                  <?php if ( $area_label ) : ?>
                    <p class="text-sm font-bold tracking-widest uppercase text-stone-500 mb-2"><?php echo $area_label; ?></p>
                  <?php endif; ?>
                  <?php if ( $area_text ) : ?>
                    <p class="text-stone-300 leading-relaxed"><?php echo $area_text; ?></p>
                  <?php endif; ?>
                </div>
              </div>
            </div>
